...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.WifiShot/sessions/'
        self.pixiewps_dir = f'{user_home}/.WifiShot/pixiewps/'
...
def usage():
    return """
WifiShotPin 0.0.2 (c) 2017 rofl0r, modded by ramanveerji
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='WifiShotPin 0.0.2 (c) 2017 rofl0r, modded by ramanveerji',
